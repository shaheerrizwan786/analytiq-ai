...
const RAW: Omit<ReviewRow, 'id'>[] = [
  ...
  // ── Recent (last 7 days): Apr 28 – May 2 ──────────────────────────────
  {
    platform: 'google',
...
export const demoDashboardData: DashboardData = {
  ...
  confidence: {
    level: 'High',
    percentage: 88,
    note: `Based on ${total} reviews across Google, TripAdvisor, and Yelp collected Feb–May 2026.`,
  },
};
