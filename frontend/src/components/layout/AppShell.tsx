...
export default function AppShell({ children, mainClassName }: AppShellProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FBF4EC] via-white to-orange-50/20 dark:from-[var(--dk-bg)] dark:via-[var(--dk-via)] dark:to-[var(--dk-bg)] flex flex-col transition-colors">
      <Navbar />
